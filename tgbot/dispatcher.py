...
def setup_dispatcher(dp):
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            ...
            SURNAME: [
                MessageHandler(Filters.text, onboarding_handlers.user_surname)
            ],
            PHOTO: [
                MessageHandler(Filters.photo, onboarding_handlers.user_photo)
            ],
            VIDEO: [
                MessageHandler(Filters.video, onboarding_handlers.user_video)
            ],
            VOICE: [
            ...
            CONTACT: [
                MessageHandler(Filters.contact, onboarding_handlers.user_contact)
            ],
